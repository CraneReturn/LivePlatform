	...
	<div class="video-main">
		<div class="main-left">
			<div class="left-top">
				<div class="kind-main">
					<div class="kind-img">
						<img src="@/assets/images/video/影视.png" alt="" />
					</div>
					<div class="kind-name">影视</div>
				</div>
			</div>
			<ul class="video-list">
            ...
            <div class="video-cover">
              <img src="@/assets/images/video/播放.png" alt="" />
            </div>
					</div>
      ...
      <div class="board-top">
        <div class="board-name">影视视频排行榜</div>
      </div>
      <div class="board-list">
          <div class="top-item video-item">
            ...
            <div class="video-cover">
              <img src="https://img2.baidu.com/it/u=4067814844,4223671934&fm=253&fmt=auto&app=120&f=JPEG?w=800&h=500" alt="">
            </div>
            <div class="video-detail">
              <div class="video-title">
                断魂针，绝情剑!《剑侠世界：起源》新门派古墓技能首曝
          ...
          <div class="text-item video-item">
            <div class="rank">
              4
            </div>
            <div class="video-title">
          ...
          <div class="text-item video-item">
            ...
            <div class="video-title video-item">
              断魂针，绝情剑!《剑侠世界：起源》新门派古墓技能首曝
            </div>
          </div>
          <div class="text-item video-item">
...
@import "@/views/client/styles/video/videoMain.scss";
</style>