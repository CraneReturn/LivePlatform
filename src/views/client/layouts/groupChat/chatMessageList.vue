          ...
          <div :class="{ other: message.userid != userId, self: message.userid == userId }">
            ...
            <div class="dialogWidthAll">
              <div class="dialogue" :class="{ colour: message.userid == userId }">
                ...
                <div class="checkedIcon" :class="{ radiFlag: message.checked, checkedIconflag: pushArr.length !== 0 }">
...
<style lang="scss" scoped>@import "@/views/client/styles/groupChat/chatMessage.scss";
