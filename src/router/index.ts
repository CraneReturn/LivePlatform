    ...
    routes: [
        {
            ...
            children: [
                ...
                },
                {
                    path: "/video-preview",
                    component: () =>
                        import("@/components/huh-player/index.vue"),
                },
                {
                    path: "/video-detail",
                    component: () =>
                ...
                },
                {
                    ...
                    children: [
                        ...
                        },
                        {
                            ...
                            component: () =>
                                import(
                                    "@/views/client/layouts/viedoUpload/viedoManger.vue"
                                ),
                        },
                    ],
                },
        ...
        },
        {
            ...
            children: [
                ...
                },
                {
                    path: "gift",
                    component: () =>
                        import("@/views/admin/layouts/giftManage/gift.vue"),
                },
            ],
        },
        {
        ...
        },
        {
            path: "/category",
            component: () =>
                import("@/views/client/layouts/category/index.vue"),
            meta: {
                title: `${projectName}`,
                requiresAuth: false,
            },
        ...
        },
        {
            path: "/page",
            component: () =>
                import("@/views/admin/layouts/giftManage/index.vue"),
            meta: {
                title: `${projectName}`,
                requiresAuth: false,
            },
        },
        {
            path: "/send",
            component: () =>
                import("@/views/streamer/components/videoPlayer.vue"),
            meta: {
                title: `${projectName}`,
                requiresAuth: false,
            },
        ...
        {
            path: "/push",
            component: () => import("@/components/streaming-client/index.vue"),
            meta: {
                title: `${projectName}`,
                requiresAuth: false,
            },
